package com.vc.mapify.Permissions;
...
//CLASS TO GET PERMISSIONS FROM THE USER
public class AppPermissions {

    //CHECKS USER STORAGE AND REQUESTS STORAGE PERMISSION
    ...
    //CHECKS THE USER'S LOCATION AND REQUESTS TO ACCESS THE USER'S LOCATION
